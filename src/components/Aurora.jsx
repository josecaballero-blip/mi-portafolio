...
export default function Aurora(props) {
  const { colorStops = ['#00d4ff', '#8b5cf6', '#00d4ff'], amplitude = 1.0, blend = 0.5 } = props;
  ...
  useEffect(() => {
    ...
    let animateId = 0;
    let lastFrame = 0;
    const FRAME_INTERVAL = 1000 / 30; // Throttle to 30fps — saves 50% GPU vs 60fps

    // Cache parsed colors — no allocation per frame
    let cachedStops = colorStopsArray;
    let cachedStopsSrc = colorStops;
